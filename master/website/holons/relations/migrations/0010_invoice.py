# Generated by Django 2.2 on 2021-05-20 07:28
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('relations', '0009_auto_20210508_1415'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('due_date_at', models.DateTimeField(blank=True, default=None, null=True)),
                ...
                ('accepted_by', models.ManyToManyField(blank=True, related_name='invoices_accepted', to=settings.AUTH_USER_MODEL)),
                ('owner', models.ManyToManyField(blank=True, related_name='invoices', to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
