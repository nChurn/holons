# Generated by Django 2.2 on 2021-05-23 14:57
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_data', django_jsonfield_backport.models.JSONField(default=None, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subscription_type', models.CharField(default='holons core', max_length=255)),
                ('is_active', models.BooleanField(default=False)),
                ('created_at', models.DateTimeField(blank=True, default=None, null=True)),
                ('expires_at', models.DateTimeField(blank=True, default=None, null=True)),
                ('next_charge_at', models.DateTimeField(blank=True, default=None, null=True)),
                ('owner', models.ManyToManyField(blank=True, related_name='subscriptions', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Payment',
            fields=[
                ...
                ('status', models.CharField(default='fail', max_length=255)),
                ('created_at', models.DateTimeField(auto_now=True)),
                ('paid_at', models.DateTimeField(auto_now=True, null=True)),
                ('subscription', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='subscription.Subscription')),
            ],
        ),
    ]
